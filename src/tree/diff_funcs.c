...
#define _SUM(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_SUM},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _SUB(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_SUB},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _MUL(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_MUL},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _DIV(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_DIV},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _POW(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_POW},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _SIN(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_SIN},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _COS(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_COS},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _TG(lt, rt)     tree_ctor((tree_data_u){.op = OP_TYPE_TG},      NODE_TYPE_OP,    NULL,   lt,     rt)
#define _CTG(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_CTG},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _ARCSIN(lt, rt) tree_ctor((tree_data_u){.op = OP_TYPE_ARCSIN},  NODE_TYPE_OP,    NULL,   lt,     rt)
#define _ARCCOS(lt, rt) tree_ctor((tree_data_u){.op = OP_TYPE_ARCCOS},  NODE_TYPE_OP,    NULL,   lt,     rt)
#define _ARCTG(lt, rt)  tree_ctor((tree_data_u){.op = OP_TYPE_ARCTG},   NODE_TYPE_OP,    NULL,   lt,     rt)
#define _ARCCTG(lt, rt) tree_ctor((tree_data_u){.op = OP_TYPE_ARCCTG},  NODE_TYPE_OP,    NULL,   lt,     rt)
#define _SH(lt, rt)     tree_ctor((tree_data_u){.op = OP_TYPE_SH},      NODE_TYPE_OP,    NULL,   lt,     rt)
#define _CH(lt, rt)     tree_ctor((tree_data_u){.op = OP_TYPE_CH},      NODE_TYPE_OP,    NULL,   lt,     rt)
#define _TH(lt, rt)     tree_ctor((tree_data_u){.op = OP_TYPE_TH},      NODE_TYPE_OP,    NULL,   lt,     rt)
#define _CTH(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_CTH},     NODE_TYPE_OP,    NULL,   lt,     rt)
#define _LOG(lt, rt)    tree_ctor((tree_data_u){.op = OP_TYPE_LOG},     NODE_TYPE_OP,    NULL,   lt,     rt)
